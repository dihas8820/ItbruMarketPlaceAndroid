...
import com.myproject.itbrumarketplace.databinding.ActivityNavigationBinding
import com.myproject.itbrumarketplace.ui.login.LoginActivity
...
//        setupActionBarWithNavController(navController, appBarConfiguration)
        ...
        navView.setOnItemSelectedListener {
            ...
            if(it.itemId == R.id.navigation_notifications){
                ...
                navController.navigate(it.itemId)
                Log.d("TAG", "onCreate: warning" + it.itemId)
            }
